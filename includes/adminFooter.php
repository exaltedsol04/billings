<!--start overlay-->
	...
	<?php } if($page=='purchase-request.php' || $page=='stock-transfer.php' || $page=='products.php' || $page=='pos.php' || $page=='online-stock-transfer.php' || $page=='purchase-stock-add.php' || $page=='online-processing-orders.php' || $page=='purchase-accept.php') {  ?>
