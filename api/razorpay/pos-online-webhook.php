...
try {
    ...
    if ($event === 'payment.captured') {
        ...
        $setValues = "payment_status = :payment_status, transaction_id = :transaction_id, payment_source=:payment_source, status = :status , updated_at=:updated_at";
    ...
    if ($event === 'refund.processed') {
        ...
        $setValues = "payment_status = :payment_status, updated_at=:updated_at";
