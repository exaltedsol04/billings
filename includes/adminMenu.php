    ...
    <aside class="sidebar-wrapper" data-simplebar="true">
      ...
      <div class="sidebar-nav">
          ...
          <ul class="metismenu" id="sidenav">
			...
			<li <?php if($page=='purchase-stock-add.php' || $page=='purchase-stock-list.php'  || $page=='purchase-stock-list-view.php' || $page=='approved-stock-list.php' || $page=='purchase-summary-list.php' || $page== 'purchase-stock-multiple-add.php') { echo ('class="mm-active"');} ?>>
			  <a href="javascript:;" class="has-arrow">
